(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@apollo/client/link/core'), require('@apollo/client/utilities')) :
    typeof define === 'function' && define.amd ? define(['exports', '@apollo/client/link/core', '@apollo/client/utilities'], factory) :
    (global = global || self, factory(global['apollo-cache-persist'] = {}, global.core, global.utilities));
}(this, (function (exports, core, utilities) { 'use strict';
    ...
    var QueueLink = (function (_super) {
        ...
        QueueLink.prototype.open = function () {
            var _this = this;
            this.isOpen = true;
            var opQueueCopy = __spreadArrays$1(this.opQueue);
            this.opQueue = [];
        ...
        QueueLink.addLinkQueueEventListener = function (opName, event, callback) {
            ...
            var newListener = (_a = {},
                _a[key] = __spreadArrays$1((key in QueueLink.listeners ? QueueLink.listeners[key] : []), [{ id: newGuid, callback: callback }]),
                _a);
            QueueLink.listeners = __assign$1(__assign$1({}, QueueLink.listeners), newListener);
            return newGuid;
        };
    ...
    var QueuePersistor = (function () {
        function QueuePersistor(options) {
            ...
            QueueLink.addLinkQueueEventListener("", "change", function (item) {
